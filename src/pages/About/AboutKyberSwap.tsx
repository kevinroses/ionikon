...
import { Edit, Plus, Repeat } from 'react-feather'
    ...
    >
      ...
      {above768 && (
        <Flex alignItems="center" width="fit-content">
          <KyberSwapSlippage>
            <img src={isDarkMode ? '/logo-dark.svg' : '/logo.svg'} width="88px" alt="MetabeoSwap" />
      ...
      <AboutPage>
        ...
        <Wrapper>
          ...
          <OverflowStatisticWrapper>
            ...
            <Text fontStyle="italic" textAlign="right" fontSize="12px" marginTop="8px" color={theme.subText}>
              **<Trans>Applicable to MetabeoSwap Classic</Trans>
            </Text>
          </OverflowStatisticWrapper>
            ...
            <Flex flex={1} flexDirection="column" height="max-content">
              ...
              >
                <Trans>
                  ...
                  MetabeoSwap) and identify the best trade route for you.
                </Trans>
              </Text>
          ...
          >
            <Trans>
              ...
              passive income - MetabeoSwap Elastic and MetabeoSwap Classic. Simply deposit your liquidity and start
              earning.
            </Trans>
          </Text>
          ...
          >
            <Flex flex={1} flexDirection="column">
              ...
              <Text color={theme.text} marginTop={['40px', '48px']} lineHeight={1.5}>
                <Trans>
                  Anyone can provide liquidity to MetabeoSwap by depositing tokens e.g. Traders, Token Teams.
                </Trans>
              </Text>
              <Text color={theme.text} marginTop="24px" lineHeight={1.5}>
                <Trans>
                  Anyone can access this liquidity from MetabeoSwap for their own use case e.g. Dapps, Aggregators.
                </Trans>
              </Text>
              <Text color={theme.text} marginTop="24px" lineHeight={1.5}>
                <Trans>
          ...
          <AboutMEO>
            ...
            <Flex width="100%" alignSelf="center" flexDirection="column" height="max-content">
              ...
              <Text as="h2" marginTop="12px" fontSize={['28px', '36px']} fontWeight="500">
                <Trans>Metabeo Network Crystal (MEO)</Trans>
              </Text>
              <Text
                fontSize="16px"
                marginTop={['40px', '48px']}
              ...
              >
                <Trans>
                  MEO is a utility and governance token, and an integral part of Metabeo Network and its flagship
                  product MetabeoSwap. It is the glue that connects different stakeholders in Metabeo&apos;s ecosystem
                </Trans>
              </Text>
              <img
                width="75%"
