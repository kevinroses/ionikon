...
const AboutMEO = lazy(() => import(/* webpackChunkName: 'about-knc' */ './About/AboutMEO'))
              ...
              <BodyWrapper>
                ...
                <Web3ReactManager>
                  <Switch>
                    ...
                    <Route exact path="/about/metabeoswap" component={AboutKyberSwap} />
                    <Route exact path="/about/meo" component={AboutMEO} />
