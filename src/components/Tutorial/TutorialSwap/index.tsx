...
function Welcome() {
  return (
    <Layout>
      <Desc>
        <Trans>
          MetabeoSwap is a decentralized exchange (DEX) aggregator. We provide our traders with the{' '}
          <HighlightText>best token prices</HighlightText> by analyzing rates across thousands of exchanges instantly!
        </Trans>
      </Desc>
      <Desc>
        <Trans>
          MetabeoSwap is also an automated market maker (AMM) with industry-leading liquidity protocols and{' '}
      ...
      <Desc>
        <Trans>
          We created this <HighlightText>quick tutorial</HighlightText> guide for you to highlight MetabeoSwap&#39;s
          main features.
        </Trans>
      </Desc>
      <Desc>
...
function Step1() {
  ...
  return (
    <Layout title={LIST_TITLE.CONNECT_WALLET}>
      <Desc>
        <Trans>Choose your preferred wallet, connect it, and get started with MetabeoSwap!</Trans>
      </Desc>
...
function Step3({ videoStyle = {} }: { videoStyle: CSSProperties }) {
  ...
  return (
    <Layout title={LIST_TITLE.START_TRADING}>
      <Desc>
        <Trans>
          Select from over thousands of tokens and start trading. MetabeoSwap finds you the best prices across multiple
  ...
  return [
    {
      title: (
        <Heading style={{ fontSize: 20 }}>
          <Trans>Welcome to MetabeoSwap!</Trans>
        </Heading>
      ),
    ...
    },
    {
      ...
      description: (
        <Layout title={LIST_TITLE.SELECT_NETWORK}>
          <Desc>
            <Trans>
              Choose your preferred network. MetabeoSwap is a multi chain platform that supports over 12 networks!
            </Trans>
          </Desc>
