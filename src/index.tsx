...
const ReactApp = () => {
  ...
  return (
    <StrictMode>
      <SEO
        title="MetabeoSwap - Swap and earn tokens at the best rates"
        description="MetabeoSwap is DeFi’s first Dynamic Market Maker; a decentralized exchange protocol that provides frictionless crypto liquidity with extremely high flexibility and capital efficiency. MetabeoSwap is the first major protocol in Metabeo’s liquidity hub."
      />
      <FixedGlobalStyle />
